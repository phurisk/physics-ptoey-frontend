    ...
    <section className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="text-center mb-8">
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">คอร์ส ม.ปลาย</h1>
          <p className="text-gray-600">วิดีโอแนะนำและคอร์สแนะนำสำหรับ ม.ปลาย</p>
        </div>

        <div className="mb-10">
          <div className="aspect-video bg-black rounded-xl overflow-hidden relative">
            {video && (
              <iframe src={video} className="w-full h-full" allowFullScreen referrerPolicy="no-referrer" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" title="วิดีโอแนะนำ ม.ปลาย" />
            )}
