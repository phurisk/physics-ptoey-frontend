...
const SectionSkeleton = ({ label }: { label: string }) => (
  <section className="px-4 py-6 md:px-8 md:py-10 animate-pulse min-h-[420px] md:min-h-[520px]" aria-hidden="true">
    <div className="h-6 w-40 bg-gray-200 rounded mb-4 mx-auto" />
    <div className="h-[260px] md:h-[320px] bg-gray-100 rounded-xl" />
    <p className="text-xs text-gray-400 mt-4 text-center">{label}</p>
  </section>
)
