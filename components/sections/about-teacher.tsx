            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="bg-white rounded-lg p-2 shadow-sm flex items-center justify-center w-20 h-20">
                      <Image src="/logo/โรงเรียนจุฬาภรณราชวิทยาลัย.png" alt="โรงเรียนจุฬาภรณราชวิทยาลัย" width={64} height={64} className="object-contain" />
                    </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="bg-white rounded-lg p-2 shadow-sm flex items-center justify-center w-20 h-20">
                      <Image src="/logo/science_chula.png" alt="โรงเรียนจุฬาภรณราชวิทยาลัย" width={100} height={100} className="object-contain" />
                    </div>
                    <div className="flex-1">
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="bg-white rounded-lg p-2 shadow-sm flex items-center justify-center w-20 h-20">
                      <Image src="/logo/CHULA_ENG.png" alt="โรงเรียนจุฬาภรณราชวิทยาลัย" width={100} height={100} className="object-contain" />
                    </div>
                    <div className="flex-1">
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="bg-white rounded-lg p-2 shadow-sm flex items-center justify-center w-20 h-20">
                      <Image src="/logo/มสท.png" alt="โรงเรียนจุฬาภรณราชวิทยาลัย" width={100} height={100} className="object-contain" />
                    </div>
                    <div className="flex-1">
                      <h5 className="font-semibold text-gray-900 mb-1">ปริญญาโท</h5>
